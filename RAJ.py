...
\033[1;91m    ║══▒═💀═▒═💀═▒═══¤═¤═¤════════════¤═══¤═══¤═══║
\033[1;96m    ║✯ 𝕮𝖗𝖊𝖆𝖙𝖔𝖗  Raj Khondokar        ║    
...
print  """
\033[1;97m************************************************
\033[1;96m~ IM NOT RESPONSIBLE FOR ANY MISS USE ℛ𝒶𝒥
\033[1;97m************************************************
...
while (loop == 'true'):
    ...
    if (username == CorrectUsername):
        ...
        if (password == CorrectPassword):
            print "Logged in successfully as " + username #Dev:Khondkkar Imran
	    time.sleep(2)
            loop = 'false'
        else:
            print "\033[1;96mWrong Password"
            os.system('xdg-open https://www.youtube.com/channel/UCyo6dFjHh_ooruru-a8383iIs2Aw')
    else:
        print "\033[1;96mWrong Username"
        os.system('xdg-open https://www.youtube.com/channel/UCyo6dFjHh_8373πhdh-a83yeIs2Aw')
...
def pilih_super():
	...
	print "  \033[1;91m«---•◈•---Developed By Raj Khondokar YT--•◈•---»" #Dev:RAJ
...
•\033[1;95m◈•▬ ▬ ▬ ▬ ▬ ▬ ▬•◈•▬ ▬ ▬ ▬ ▬ ▬ ▬•◈•.
: \033[1;91m ....Khondokar RaJ YT....... \033[1;95m :
•\033[1;95m◈•▬ ▬ ▬ ▬ ▬ ▬ ▬•◈•▬ ▬ ▬ ▬ ▬ ▬ ▬•◈•.' 
                Facebook
              \033[1;91m Usama Arain"""
